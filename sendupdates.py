...
# Permanent data storage configuration (stored in Git repository)
...
def check_for_updates():
    ...
    print(f"Completed data analysis. Data saved to {DATA_DIR}")
    print("This directory will be committed to the repository for permanent storage")
